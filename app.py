...
KEYWORDS = [
    ...
    "הקצאת העובדים", "השפעת מדיניות", "שרידות של עסקים"
]
...
PRIORITY_COMMITTEES = [
    ...
    "ועדת המדע והטכנולוגיה", "הוועדה המיוחדת לעובדים זרים", "עובדים זרים", "המיוחדת לעובדים"
]
...
# ==========================================
# 4. מנגנון בקרת כניסה פשוט וחסין קריסות
# ==========================================
...
if not st.session_state["authenticated"]:
    ...
    if password == "WoltPolicy2026":
        ...
        st.success("הסיסמה נקלטה בהצלחה! אנא לחץ על כפתור הכניסה:")
        if st.button("הכנס למערכת"):
            st.rerun()
    elif password:
        st.error("⚠️ סיס
